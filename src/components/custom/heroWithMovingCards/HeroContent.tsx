...
export const HeroContent = ({ id, className }: HeroContentProps) => {
  ...
  return (
    <section
      ...
      className={cn(
        'relative py-12 md:py-16 lg:py-20 min-h-screen w-full',
        className
      )}
    >
      {/* Centered Content */}
      <div className="flex flex-col items-center text-center max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <Button
            variant="outline"
            size="lg"
            className="px-8 py-3 text-base font-semibold border-2 border-gray-300 text-gray-700 hover:bg-gray-50"
            style={{
              borderBottomRightRadius: '16px',
              borderTopLeftRadius: '16px',
            }}
